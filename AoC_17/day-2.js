...
console.log(getCheckSum(spreadsheet));

// Part 2
console.log("Part 2");

function findDivSum (arr) {
	var divSum = 0;
	for (var i = 0; i< arr.length; i++) {
		divSum += findRowDiv(arr[i]);
		console.log(divSum);
	}
	return divSum;
}
...
//console.log(findDivSum(test));
console.log(findDivSum(spreadsheet));
